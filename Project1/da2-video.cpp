...
int main(int argc, char *argv[]) {
  ...
  DA2Network da_net( "../Project1/model_fp16.onnx" );
  ...
  for(;;) {
    ...
    *capdev >> src;
    ...
    int foregroundDepth = 150;
    cv::Mat mask;
    cv::threshold(dst,mask, foregroundDepth, 255, cv::THRESH_BINARY);
